...
This repository is the source of record for **Hallatec Forge Hub**, one of the nine tools in
...
| Property | Value |
|---|---|
| Tool | Hallatec Forge Hub |
| Canonical deployment | https://forge.hallatec.com/ |
| Source of record | https://github.com/hallatec/hallatec-forge-hub |
...
A genuine deployment returns `repository: "https://github.com/hallatec/hallatec-forge-hub"` and
`canonical: "https://forge.hallatec.com/"`. `Object.freeze` means a fork cannot quietly mutate
...
**4. Bidirectional link.** This repository names `https://forge.hallatec.com/` as its canonical
deployment, and that deployment names `https://github.com/hallatec/hallatec-forge-hub` as its source. Either direction
...
curl -s https://forge.hallatec.com/ | grep -A2 'code-repository'

# 2. The runtime object agrees (browser console)
#    HTC.provenance.repository === "https://github.com/hallatec/hallatec-forge-hub"

# 3. The canonical link points back at the tool's own subdomain
curl -s https://forge.hallatec.com/ | grep 'rel="canonical"'
```
